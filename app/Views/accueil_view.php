...
<head>
	...
	<title>Disctroy(es) | Accueil</title>
	<!--META-->
	<meta name="description" content="Site officiel de l'association DiscTroy(es), club d'Ultimate Frisbee à Troyes." />
...
<body>
	...
	<header>
		<div class="header-nav">
			...
			<nav>
				<a href="" class="header-link activ">ACCUEIL</a>
				<a href="" class="header-link">ACTUALITÉS</a>
				<div class="header-deroul">
